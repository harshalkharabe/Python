...
# # assert keyword
# Python Assertions in any programming language are the debugging tools
# that help in the smooth flow of code. Assertions are mainly assumptions
# that a programmer knows or always wants to be true and hence puts them
# in code so that failure of these doesn’t allow the code to execute further. 
